Imports System.Net
Imports System.IO
Public Class FrmReadSingleShareValue
    ...
    Private Sub ReadBoerseBerlin_Click(sender As Object, e As EventArgs) Handles ReadBoerseBerlin.Click
        L_SharePrice.Text = "--"
        L_SharePrice.Text = Read_BoerseBerlin_de(T_WKN.Text)
    End Sub

    Private Sub Wallstreet_Click(sender As Object, e As EventArgs) Handles Wallstreet.Click
        L_SharePrice.Text = "--"
        L_SharePrice.Text = Read_WallStreet_de(T_WKN.Text)
    End Sub
